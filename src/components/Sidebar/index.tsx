...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const navClass = (active: boolean) =>
    `group relative flex items-center gap-3 rounded-xl px-4 py-2.5 text-sm font-medium duration-200 ease-in-out ${
      active
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-10 flex h-screen w-[260px] flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="py-2 px-4 lg:px-5">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-3 ml-4 text-xs font-semibold tracking-widest text-bodydark2">
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1">
              {/* <!-- Menu Item Dashboard --> */}
              <li>
                <NavLink to="/" className={navClass(pathname === '/')}>
              ...
              <li>
                <NavLink
                  to="/billing"
                  className={navClass(pathname.includes('billing'))}
                >
              ...
              <li>
                <NavLink
                  to="/quotations"
                  className={navClass(pathname.includes('quotation'))}
                >
              ...
              <li>
                <NavLink
                  to="/service"
                  className={navClass(pathname.includes('service'))}
                >
              ...
              <li>
                <NavLink
                  to="/customer"
                  className={navClass(pathname.includes('customer'))}
                >
